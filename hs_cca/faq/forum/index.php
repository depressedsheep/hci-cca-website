...
<html lang="en" class="f9f9f9_bg" manifest="/hs_cca/cache.appcache">
    ...
    <body>
            ...
            <div id="navbar">
                <div id="menu">
                    ...
                    <div id="m5" class="navbarmenu" data-link="0">
                        <a href="/hs_cca/faq/"><div class="menu_tab" id="tab5">FAQ &amp; Forum</div></a>
                    </div>
        ...
        <div id="content" class="wrap">
            ...
            <div id="topcontent">
                <h3>Forum</h3>
                <p>Sorry, but the forum is currently still under development.</p>
                <p>If you have queries, you may approach your CCA teacher-in-charge or PE teachers. If you need to approach someone for generic issues or need to communicate with someone higher than the teacher-in-charge, the following are the key personnel of the PE/CCA Department and their email address:</p>
                <ul style="list-style: square inside url('data:image/gif;base64,R0lGODlhBQAKAIABAAAAAP///yH5BAEAAAEALAAAAAAFAAoAAAIIjI+ZwKwPUQEAOw==');">
                    <!--<li>Mr Lee Kai Sim (Director PE/CCA) <a href="maito:leeksim@hci.edu.sg" class="email">leeksim@hci.edu.sg</a></li>-->
                    <li>Mr Tok Aik Lin (Principal Consultant PE/CCA) <a href="maito:tokal@hci.edu.sg" class="email">tokal@hci.edu.sg</a></li>
                    <li>Mr Tan Chee Wee (Principal Consultant Student Development) <a href="maito:tancw@hci.edu.sg" class="email">tancw@hci.edu.sg</a></li>
                    <li>Mr David Woon (Educational Consultant PE/CCA & Outdoor Education) <a href="maito:woontw@hci.edu.sg" class="email">woontw@hci.edu.sg</a></li>
                </ul>
                <!--<p>This is a forum for you to ask relevant questions about CCA life that have not already been answered in the <a href="/hs_cca/faq/">FAQ page</a>, or if you have any further clarifications regarding the answers in the <a href="/hs_cca/faq/">FAQ page</a>.</p>
                <p>You can <a href="login.php">log in here</a> using the accounts that have been specially set up for you.</p>-->
            </div>
        ...
        <footer class="wrap">
            ...
            <br/>
            <a href="/hs_cca/sitemap/" target="_blank">Sitemap</a>&nbsp;|&nbsp;<a href="">Report an Issue</a>
        </footer>
        <!--/footer-->
        <!--overlays-->
