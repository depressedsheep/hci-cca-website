...
$ignore=array(
	...
	"loginCheck.php",
	"registerUser.php",
	"updateAccountProcessing.php",
	"ban.php",
	".smileys",	".wysiwygPro_preview_7087e68140698ec8bbed34660278164d.php",
	"shortStoryReflectionsProcessing.php"
);
...
if(!$imgpath)
	$imgpath=".";
echo "<li><img src=\"$imgpath/sitemap.gif\" align=\"middle\" alt=\"\" /><strong><a href=\"$startin/\">Sitemap of my Website</a></strong>\n";
...
function showlist($path){
	...
	if(is_dir($path)){
		...
		natcasesort($dirs);
		$url=str_replace($_SERVER['DOCUMENT_ROOT'],"",$path);		$n=substr_count("$url/$","/");
