...
<html lang="en" class="f9f9f9_bg" manifest="/hs_cca/cache.appcache">
    <head>        
        ...
        <title>CCA Website (Sitemap)</title>
        ...
        <link rel="stylesheet" href="/hs_cca/styles/report.css" type="text/css">
        ...
        <script src="/hs_cca/scripts/report.js"></script>
    </head>
    <body>
        <!--header-->
        <!--<div id="menu_toggle">
            ...
            <div id="navbar">
                <div id="menu">
                    ...
                    <div id="m6" class="navbarmenu" data-link="0">
                        <a href=""><div class="menu_tab" id="tab6">About/Contact</div></a>
                    </div>
                    <div id="search-area">
        ...
        <footer class="wrap">
            ...
            <br/>
            <a href="">Sitemap</a>&nbsp;|&nbsp;<a href="/hs_cca/report/">Report an Issue</a>
        </footer>
        <!--/footer-->
        <!--overlays-->
